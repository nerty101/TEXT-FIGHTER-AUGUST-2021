...
{
if ((consecvic > 0) && ((normag > 0) && (enemyhp > 0)))///change from > 2, new
{
///++dubon;
///}moved below new
if (magchn <= 0)
...
if ((posmag > 0) && (magchn < 3) && (dubon < 1) && (bonchn < 1))
{
...
else if ((posmag > 0) && (magchn < 3) && (dubon > 0) && (bonchn > 0))///new added bonchn and above
{
...
if ((spctrbon > 1) && (dice5 > dice6) && (magsp3 < 1) && (magsp < 1) && (magsp4 < 1) && (ultsp < 4) && (bonchn2 < 3))///new bonchn2
{
