...
int ctr = 0, ctr2 = 0, playerhp = 5, enemyhp = 5, contest = 0, consecvic = 0, consecvic2 = 0, consectr = 0, spctrbon = 0, ctrbonon = 0, ctrbondef = 0, consecvic3 = 0, spctrbon2 = 0, diceQ2 = 0, g2 = 0;
...
int spmag = 0, spmag2 = 0, magsp = 0, magsp2 = 0, normag = 0, magsp3 = 0, sumag2 = 0, sumag = 0, magsp7 = 0, consecvic5 = 0, consecvic7 = 0, spctrbon7 = 0, spdup = 0, supdup = 0, supdup2 = 0, e2 = 0;
...
int wnct = 0, cpuwn = 0, wnct2 = 0, wnctrec = 0, new1 = 0, new2 = 0, new3 = 0, new4 = 0, new5 = 0, new6 = 0, cpuwnct = 0, cpuwn2 = 0, new7 = 0, cpuwn3 = 0, wnct3 = 0, new10 = 0, new8 = 0, d2 = 0;
...
if ((dice3 > dice4) && (magsp4 < 1) && (spmag2 > 3) && (spmag >= 0) && (sumag2 < 1))
{
...
if (((consecvic2 < 3) && (spctrbon < 2) || (consecvic2 < 3)) && (dice5 > dice6) && (magsp > 0) && (magsp3 < 1) && (bonchn2 < 3) && (ultsp < 4))
{
...
if ((spctrbon > 1) && (dice5 > dice6) && (magsp3 < 1) && (magsp < 1) && (magsp4 < 1) && (ultsp < 4))
{
...
if ((ctr > 5) && (new6 < 1) && (cpusp  < 2) && (bonchn < 3) && (magchn < 3))
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     It was a very effective technique!\n");
else if (diceQ == 2)
printf("     It was a very well-timed manoeuvre!\n");
else if (diceQ == 3)
...
if ((cpusp < 2) && ((ctr < 6) || (new6 > 0)) && (bonchn7 > 2) && (magchn5 > 2) && (((new2 > 0) && (new10 > 1)) || (new3 > 0)))
printf("\n");
if (new3 > 0)
printf("     A new Magic Bonus Chain Record!\n");
if ((cpusp > 1) && (ctr < 6) && (new6 > 0) && (bonchn7 < 3) && (magchn5 < 3))
printf("\n");
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2) && (((new2 < 1) && (new10 < 2)) && (new3 < 1)))
printf("\n");
if (new6 > 0)
...
if ((ctr > 5) && (new6 < 1) && (cpusp  < 2) && (bonchn7 < 3) && (magchn < 3))
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     You used an excellent finishing move!\n");
else if (diceQ == 2)
printf("     It was an exciting end to the fight!\n");
else if (diceQ == 3)
printf("     It was a nice conclusion to the fight!\n");
else if (diceQ == 4)
...
if ((cpusp < 2) && (ctr < 6) && (new6 < 1) && (bonchn7 > 2) && (magchn5 > 2)) ///problem < 3 or < 2 ???
printf("\n");
if (magchn5 > 2) //&& (posmag2 > 0))
{
++new8;
...
if ((cpusp < 2) && (ctr < 6) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2) && (((new2 < 1) && (new10 < 2)) && (new3 < 1)))
printf("\n");
if ((cpusp < 2) && (ctr > 5) && (new6 > 0) && (bonchn7 > 2) && (magchn5 > 2))
printf("\n");
if (magchn5 > 2)
{
if ((cpusp < 2) && ((ctr < 6) || (new6 > 0)) && (bonchn7 > 2) && (magchn5 > 2) &&  (((new2 > 0) && (new10 > 1)) || (new3 > 0)))
